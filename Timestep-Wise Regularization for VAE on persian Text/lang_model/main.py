...
# Digikala Dataset option ##############
elif args.dataset == "digikala":
    Train = Corpus(base_path+'/dataset/digikala/digikala_train.txt', min_word_count=args.min_word_count, is_digikala=True)
    Valid = Corpus(base_path+'/dataset/digikala/digikala_val.txt', word_dic=Train.word_id, min_word_count=args.min_word_count, is_digikala=True)
    Test = Corpus(base_path+'/dataset/digikala/digikala_test.txt', word_dic=Train.word_id, min_word_count=args.min_word_count, is_digikala=True)
########################################
